...
```shell script
wget "https://raw.githubusercontent.com/theapache64/create-compose-desktop-app/master/install.sh" -q --show-progress -O install.sh && sh install.sh && source ~/.bashrc
```
...
1. Download latest `jar`
   from [releases](https://github.com/theapache64/create-compose-desktop-app/releases/latest/download/create-compose-desktop-app.main.jar)
1. Run `java -jar create-compose-desktop-app.main.jar`
...
=======
# create-compose-desktop-app
>>>>>>> 4b08b2b54aa41d579f5d389551b886e561b49a9e
